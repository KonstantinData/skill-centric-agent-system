...
description: Plan and summarize conservative repository task execution using read-only inspection tools. Use when a runtime profile selects task-execution-planning or when maintaining this SCAS registry skill module and its handler, tools, policies, validators, tests, or instruction pack.
---
