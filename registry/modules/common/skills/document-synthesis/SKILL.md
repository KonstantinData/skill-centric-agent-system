...
description: Synthesize durable technical documentation updates from profile-authorized context. Use when a runtime profile selects document-synthesis or when maintaining this SCAS registry skill module and its handler, tools, policies, validators, tests, or instruction pack.
---
