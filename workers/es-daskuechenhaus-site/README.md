...
- `/index.php`: protected user-specific overview for open tasks, email inbox
  assignments, appointments, news, goals, and active delegations.
...
- `/overview-api/*`: protected Worker proxy for overview form submissions such
  as task creation and manual email-to-case assignment.
