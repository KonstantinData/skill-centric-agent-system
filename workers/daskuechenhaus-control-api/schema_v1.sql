...
CREATE TABLE IF NOT EXISTS customers (
  ...
  postal_code TEXT,
  city TEXT,
  is_nato INTEGER NOT NULL DEFAULT 0 CHECK (is_nato IN (0, 1)),
  has_custom_vat INTEGER NOT NULL DEFAULT 0 CHECK (has_custom_vat IN (0, 1)),
  custom_vat_rate TEXT,
  ...
  e_invoice INTEGER NOT NULL DEFAULT 0 CHECK (e_invoice IN (0, 1)),
